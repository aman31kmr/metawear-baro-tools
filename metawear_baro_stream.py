...
def connect_device(device):
    ...
    # after previous crashes / stale connections. BLE may also time out once and succeed on
    # a second attempt ("Timed out while trying to connect to remote device"). Retry a few
    ...
    for attempt in range(1, 6):
        try:
            ...
            retryable = (
                ...
                or ("Operation now in progress" in msg)
                or ("timed out while trying to connect" in msg_l and "remote" in msg_l)
            )
