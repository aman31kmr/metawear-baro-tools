...
class IMUStreamer:
    ...
    def __init__(self, mac, *, hci=None, csv_path="imu.csv", series_maxlen=0):
        self.mac = mac
        self.hci = hci
...
def run_webui(mac, *, hci=None, csv_path="imu.csv", port=8000, open_browser=True):
    streamer = IMUStreamer(mac, hci=hci, csv_path=csv_path, series_maxlen=0)
